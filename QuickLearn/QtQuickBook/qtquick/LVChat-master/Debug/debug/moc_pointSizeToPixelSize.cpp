/****************************************************************************
** Meta object code from reading C++ file 'pointSizeToPixelSize.h'
**
...
#error "The header file 'pointSizeToPixelSize.h' doesn't include <QObject>."
...
void PointSizeToPixelSize::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        auto *_t = static_cast<PointSizeToPixelSize *>(_o);
        Q_UNUSED(_t)
        switch (_id) {
...
QT_INIT_METAOBJECT const QMetaObject PointSizeToPixelSize::staticMetaObject = { {
    &QObject::staticMetaObject,
    qt_meta_stringdata_PointSizeToPixelSize.data,
    qt_meta_data_PointSizeToPixelSize,
    qt_static_metacall,
    nullptr,
    nullptr
} };
